...
namespace PP2GameAzureFcs
{
    ...
    {
        public abstract Task<GameServerDetailData> GetGameServerByIdAsync(int pId);
        ...
        public abstract Task<int> UpdateAndSetLastPortAsync(int id, string newName, string newDns, string newRegion, int newMaxPlayers, int newPlayerCount, string newStatus);
